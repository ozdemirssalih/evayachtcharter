    ...
    <div className="min-h-screen bg-[#0c1222]">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          ...
          <div className="glass rounded-2xl p-4 md:p-6 max-w-2xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
              ...
              <Link
                href="/yachts"
                className="bg-blue-600 hover:bg-blue-700 rounded-xl py-3 font-semibold text-sm flex items-center justify-center gap-2 transition hover:shadow-lg hover:shadow-blue-600/25"
              >
      ...
      <AnimatedSection>
        <section className="px-4 py-16 max-w-7xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm">Find the perfect vessel for your adventure</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {yachtTypes.map(yt => (
              <Link
                ...
                className="glass rounded-2xl p-5 text-center hover:border-blue-500/30 transition-all group hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-900/10"
              >
                <div className="w-12 h-12 rounded-full bg-blue-600/20 flex items-center justify-center mx-auto mb-3 group-hover:bg-blue-600/30 transition">
                  <yt.icon className="w-6 h-6 text-blue-400" />
                </div>
                <h3 className="font-bold text-sm mb-1">{yt.name}</h3>
                <p className="text-[11px] text-gray-500 mb-1">{yt.desc}</p>
                <p className="text-xs text-blue-400 font-semibold">{yt.count} yachts</p>
              </Link>
            ))}
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {yachts.filter(y => y.featured).map(yacht => (
              <Link key={yacht.id} href={`/yachts/${yacht.id}`} className="block group">
                <div className="glass rounded-2xl overflow-hidden hover:border-blue-500/30 transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-900/10 duration-300">
      ...
      <AnimatedSection>
        <section className="px-4 py-16 max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 text-sm">Your luxury charter experience in four simple steps</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
            {/* Connection line */}
            <div className="hidden md:block absolute top-14 left-[12.5%] right-[12.5%] h-0.5 bg-gradient-to-r from-blue-600/0 via-blue-600/30 to-blue-600/0" />

            {howItWorks.map((step, idx) => (
              <div key={step.step} className="text-center relative">
                <div className="relative inline-block mb-4">
                  <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-600/20 to-blue-400/10 flex items-center justify-center mx-auto border border-blue-500/20">
                    <step.icon className="w-8 h-8 text-blue-400" />
                  </div>
                  <div className="absolute -top-2 -right-2 w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center text-xs font-bold">
                    {step.step}
                  </div>
                </div>
      ...
      <AnimatedSection>
        <section className="px-4 py-16 max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm">Trusted by thousands of happy charterers worldwide</p>
          </div>
          ...
          <div className="glass rounded-3xl p-6 md:p-10 relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
              ...
              <div className="flex-shrink-0">
                <div className="w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden border-2 border-blue-500/30">
                  <img
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-sm md:text-base text-gray-300 leading-relaxed mb-4 italic">
            ...
            <div className="flex items-center justify-center gap-4 mt-8">
              <button
                ...
                className="glass w-10 h-10 rounded-full flex items-center justify-center hover:bg-white/10 transition"
              >
      ...
      <AnimatedSection>
        <section className="px-4 py-16 max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm">Your safety and satisfaction are our top priorities</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {trustBadges.map(badge => (
              <div
                key={badge.title}
                className="glass rounded-2xl p-6 text-center hover:border-blue-500/30 transition-all hover:-translate-y-1"
              >
      ...
      <AnimatedSection>
        <section className="px-4 py-16">
          <div className="max-w-3xl mx-auto glass rounded-3xl p-8 md:p-12 text-center bg-gradient-to-r from-blue-600/10 to-purple-600/10">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                href="/register"
                className="bg-blue-600 hover:bg-blue-700 px-8 py-3 rounded-full font-semibold transition hover:shadow-lg hover:shadow-blue-600/25"
              >
                Create Account
              </Link>
              <Link
                href="/contact"
                className="glass px-8 py-3 rounded-full font-semibold hover:bg-white/10 transition"
              >
                Contact Us
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="glass rounded-2xl p-6">
              <div className="space-y-4">
                ...
                />
                <button className="w-full bg-blue-600 hover:bg-blue-700 py-3 rounded-xl font-semibold transition hover:shadow-lg hover:shadow-blue-600/25">
                  Send Message
                </button>
              </div>
            </div>
      ...
      <AnimatedSection>
        <section className="px-4 py-8 max-w-3xl mx-auto">
          <div className="glass rounded-2xl p-6 md:p-8 text-center">
            ...
            <p className="text-sm text-gray-500 mb-4">Get exclusive deals and new yacht arrivals in your inbox</p>
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-1 bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm outline-none focus:border-blue-500 transition"
              />
              <button className="bg-blue-600 hover:bg-blue-700 px-6 py-3 rounded-xl font-semibold text-sm transition whitespace-nowrap">
                Subscribe
              </button>
            </div>
          </div>
