      ...
      <div className="px-4 py-6">
        <div className="text-center mb-6">
          <div className="relative inline-block">
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-blue-600 to-blue-400 flex items-center justify-center text-3xl font-bold mx-auto">
              {profile.name.charAt(0)}
            </div>
            <button className="absolute bottom-0 right-0 w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center border-2 border-[#0c1222]">
        ...
        {activeSection === 'profile' && (
          <div className="space-y-4">
            <div className="glass rounded-2xl p-5">
              <h3 className="font-bold text-sm mb-4 text-gray-400 uppercase tracking-wider">Personal Information</h3>
              <div className="space-y-4">
                <div>
              ...
              {isEditing && (
                <div className="flex gap-3 mt-4 pt-4 border-t border-white/10">
                  <button
                    ...
                    className="flex-1 bg-blue-600 hover:bg-blue-700 py-2.5 rounded-xl text-sm font-semibold transition flex items-center justify-center gap-2"
                  >
                    <Save className="w-4 h-4" /> Save Changes
                  </button>
                  <button
                    onClick={handleCancelEdit}
                    className="glass py-2.5 px-4 rounded-xl text-sm hover:bg-white/10 transition"
                  >
                    Cancel
                  </button>
                </div>
            ...
            <div className="glass rounded-2xl p-5">
              <h3 className="font-bold text-sm mb-4 text-gray-400 uppercase tracking-wider">Regional Settings</h3>
            ...
            <div className="glass rounded-2xl p-5 bg-gradient-to-r from-amber-600/10 to-yellow-500/10 border-amber-500/20">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">1,200 loyalty points</p>
                </div>
              </div>
              <div className="w-full bg-white/10 rounded-full h-2 mb-2">
                <div className="bg-gradient-to-r from-amber-500 to-yellow-400 h-2 rounded-full" style={{ width: '60%' }} />
              </div>
              <p className="text-xs text-gray-500">800 more points to reach Platinum</p>
            </div>
          </div>
        )}
        ...
        {activeSection === 'preferences' && (
          <div className="space-y-4">
            <div className="glass rounded-2xl p-5">
              <h3 className="font-bold text-sm mb-4 text-gray-400 uppercase tracking-wider">Charter Preferences</h3>
              <div className="space-y-4">
                <div>
                  <label className="text-xs text-gray-500 mb-1 block">Preferred Yacht Type</label>
                ...
                <div>
                  <label className="text-xs text-gray-500 mb-1 block">Preferred Destination</label>
                  <div className="relative">
                    <select
                ...
                <div>
                  <label className="text-xs text-gray-500 mb-1 block">Typical Group Size</label>
                  <div className="flex items-center gap-4">
                    <button
            ...
            <div className="glass rounded-2xl p-5">
              <h3 className="font-bold text-sm mb-4 text-gray-400 uppercase tracking-wider">Interests</h3>
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <button
                    key={interest}
                    className="glass px-3 py-1.5 rounded-full text-xs hover:bg-blue-600/20 hover:text-blue-300 hover:border-blue-500/30 transition"
                  >
                    {interest}
                  </button>
                ))}
        ...
        {activeSection === 'notifications' && (
          <div className="space-y-4">
            <div className="glass rounded-2xl p-5">
              <h3 className="font-bold text-sm mb-4 text-gray-400 uppercase tracking-wider">Email Notifications</h3>
              <div className="space-y-4">
                {[
                  ...
                  <div key={item.key} className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={`relative w-11 h-6 rounded-full transition-colors ${
                        notifications[item.key as keyof typeof notifications] ? 'bg-blue-600' : 'bg-white/10'
                      }`}
                    >
            ...
            <div className="glass rounded-2xl p-5">
              <h3 className="font-bold text-sm mb-4 text-gray-400 uppercase tracking-wider">Other Channels</h3>
              <div className="space-y-4">
                {[
        ...
        {activeSection === 'security' && (
          <div className="space-y-4">
            <div className="glass rounded-2xl p-5">
              <h3 className="font-bold text-sm mb-4 text-gray-400 uppercase tracking-wider">Account Security</h3>
              <div className="space-y-3">
                <button className="w-full flex items-center justify-between p-3 rounded-xl hover:bg-white/5 transition">
                  <div className="flex items-center gap-3">
                ...
                <button className="w-full flex items-center justify-between p-3 rounded-xl hover:bg-white/5 transition">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-xs text-gray-500">2 devices logged in</p>
                    </div>
                  </div>
                  <ChevronRight className="w-4 h-4 text-gray-500" />
                </button>
            ...
            <div className="glass rounded-2xl p-5">
              <h3 className="font-bold text-sm mb-4 text-gray-400 uppercase tracking-wider">Payment Methods</h3>
              <div className="space-y-3">
                ...
                <button className="w-full glass py-3 rounded-xl text-sm text-blue-400 hover:bg-white/5 transition flex items-center justify-center gap-2">
            ...
            <div className="glass rounded-2xl p-5">
              <h3 className="font-bold text-sm mb-4 text-gray-400 uppercase tracking-wider">Data & Privacy</h3>
              <div className="space-y-3">
                <button className="w-full flex items-center justify-between p-3 rounded-xl hover:bg-white/5 transition">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-blue-600/20 flex items-center justify-center">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-xs text-gray-500">View our data handling practices</p>
                    </div>
                  </div>
                  <ChevronRight className="w-4 h-4 text-gray-500" />
                </button>
