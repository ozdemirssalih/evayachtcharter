      ...
      <div className="pt-16">
        ...
        <div className="relative h-72 md:h-96 overflow-hidden">
          ...
          <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 text-center">
            <div className="inline-flex items-center gap-2 glass px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-xs text-gray-300">Since 2011</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 -mt-8 relative z-20 mb-16">
            {stats.map(stat => (
              <div key={stat.label} className="glass rounded-2xl p-4 text-center hover:border-blue-500/30 transition">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={item.title} className="glass rounded-3xl p-6 hover:border-blue-500/30 transition">
          ...
          <div className="mb-16">
            ...
            <div className="relative">
              <div className="absolute left-1/2 -translate-x-1/2 w-0.5 h-full bg-white/10 hidden md:block" />
                  ...
                  <div key={item.year} className={`flex flex-col md:flex-row items-center gap-4 ${idx % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                    <div className={`flex-1 ${idx % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
                      <div className={`glass rounded-2xl p-5 inline-block ${idx % 2 === 0 ? 'md:ml-auto' : 'md:mr-auto'}`}>
                        <p className="text-sm text-blue-400 font-bold mb-1">{item.year}</p>
                        <h3 className="font-bold mb-1">{item.event}</h3>
                        <p className="text-xs text-gray-500">{item.desc}</p>
                      </div>
                    </div>
                    <div className="w-4 h-4 rounded-full bg-blue-600 border-4 border-[#0c1222] relative z-10 flex-shrink-0" />
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {team.map(member => (
                <div key={member.name} className="glass rounded-3xl overflow-hidden hover:border-blue-500/30 transition group">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {certifications.map(cert => (
                <div key={cert.name} className="glass rounded-2xl p-5 text-center hover:border-blue-500/30 transition">
          ...
          {/* CTA */}
          <div className="glass rounded-3xl p-8 md:p-12 text-center mb-16 bg-gradient-to-r from-blue-600/10 to-purple-600/10">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                href="/yachts"
                className="bg-blue-600 hover:bg-blue-700 px-8 py-3 rounded-full font-semibold transition flex items-center justify-center gap-2"
              >
                <Ship className="w-4 h-4" /> Browse Our Fleet
              </Link>
              <Link
                href="/#contact"
                className="glass px-8 py-3 rounded-full font-semibold hover:bg-white/10 transition flex items-center justify-center gap-2"
              >
