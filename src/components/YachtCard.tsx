...
export default function YachtCard({
  ...
  return (
    <div
      className="group relative glass rounded-2xl overflow-hidden hover:border-blue-500/30 transition-all duration-300 hover:shadow-xl hover:shadow-blue-900/10 hover:-translate-y-1"
    ...
    >
      ...
      <div className="relative h-48 md:h-56 overflow-hidden">
        ...
        >
          <Link
            ...
            className="w-full bg-blue-600 hover:bg-blue-700 py-2.5 rounded-xl text-xs font-semibold transition flex items-center justify-center gap-2"
      ...
      <Link href={`/yachts/${id}`} className="block p-4">
        <div className="flex items-center justify-between mb-2">
          <h3 className="font-bold text-lg group-hover:text-blue-300 transition-colors">{name}</h3>
          <span className="text-xs glass px-2 py-1 rounded-full text-blue-300">{type}</span>
        </div>
